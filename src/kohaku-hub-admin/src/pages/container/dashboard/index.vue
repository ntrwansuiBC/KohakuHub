  ...
  <div class="page-container bg-white dark:bg-black">
          ...
          <el-table-column label="Action" width="150" align="right">
            <template #default="{ row }">
              <el-button
                type="primary"
                size="small"
                @click="$router.push(`/container/users`)"
              >
                Manage
              </el-button>
            </template>
          ...
          <el-table-column label="Action" width="150" align="right">
            <template #default="{ row }">
              <el-button
                type="primary"
                size="small"
                @click="$router.push(`/container/repositories`)"
              >
                View
              </el-button>
            </template>
    ...
    <div class="mt-8">
      ...
      <div class="flex gap-4 flex-wrap">
        <el-button type="primary" @click="$router.push('/container/users')">
          <div class="i-carbon-user-multiple mr-2" />
          Manage Users
        </el-button>
        <el-button
          type="success"
          @click="$router.push('/container/repositories')"
        >
          <div class="i-carbon-data-base mr-2" />
          View Repositories
        </el-button>
        <el-button @click="$router.push('/container/commits')">
          <div class="i-carbon-version mr-2" />
          View Commits
        </el-button>
        <el-button @click="$router.push('/container/storage')">
          <div class="i-carbon-data-volume mr-2" />
          Browse Storage
        </el-button>
        <el-button @click="$router.push('/container/quota-overview')">
          <div class="i-carbon-meter mr-2" />
          Manage Quotas
        </el-button>
